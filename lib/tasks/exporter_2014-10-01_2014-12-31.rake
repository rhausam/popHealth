...
namespace :export_20141001_20141231 do
  ...
  task :cat3 do
    ...
    output << exporter.export(measures, generate_header(Time.now), effective_date, Date.parse("2014-10-01"), Date.parse("2014-12-31"))
    output.close
  end
